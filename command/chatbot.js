...
async function handleChatbotCommand(sock, chatId, message, match) {
    if (!match) {
        ...
        }, { quoted: createFakeContact(message) }); // ← Sahihi
    }
...
async function getAIResponse(userMessage, userContext) {
    ...
    const systemPrompt = `You are ${getBotName()}, a smart and friendly assistant chatting on WhatsApp. Created by 𝐁𝐋𝐀𝐂𝐊𝐋𝐎𝐑𝐃 .
